...
public class EnemyStats : MonoBehaviour
{
    ...
    private float[] health_increase_rate_levels = { 0.0f, 40.0f, 38.0f, 35.00f, 33.0f, 27.0f, 23.00f, 20.0f, 15.00f };
    private float[] health_decrease_rate_levels = { 0.0f, 20.0f, 22.0f, 25.50f, 29.5f, 32.0f, 35.00f, 37.0f, 40.00f };
    private float[] catch_distance_levels = { 0.0f, 0.7f, 0.75f, 0.8f, 0.85f, 0.90f, 0.95f, 1.05f, 1.05f };
    private float[] enemy_speed_levels = { 0.0f, 0.4f, 0.45f, 0.45f, 0.50f, 0.55f, 0.60f, 0.65f, 0.65f };
    private float[] teleportation_chance_levels = { 0.0f, 1.0f, 0.9f, 0.8f, 0.7f, 0.65f, 0.6f, 0.5f, 0.5f };
    private float[] teleport_distance_levels = { 0.0f, 35.0f, 32.0f, 30.00f, 27.5f, 25.0f, 22.00f, 20.0f, 20.50f };
